...
mri_convert  --split -ot nii  $dataDirScan/IMG00001.dcm  ./tmp/a.nii >ISImriConvertOutput.txt
sudo mv ./tmp/a0000.nii $scanISIDestinationDir/t1.nii
#----------------------------------------------------------------------------------------------------------------------------
dataDirScan=$ISISourceDir/ISI"$(printf "%02d" $i)"_0/SER2

mri_convert  --split -ot nii  $dataDirScan/IMG00001.dcm  ./tmp/b.nii >>ISImriConvertOutput.txt

sudo mv ./tmp/b0000.nii $scanISIDestinationDir/flair.nii
#----------------------------------------------------------------------------------------------------------------------------
dataDirScan=$ISISourceDir/ISI"$(printf "%02d" $i)"_0/SER3

mri_convert  --split -ot nii  $dataDirScan/IMG00001.dcm  ./tmp/c.nii >>ISImriConvertOutput.txt
...
mri_convert  --split -ot nii $dataDirScan/IMG00001.dcm  ./tmp/a.nii >TSImriConvertOutput.txt

sudo mv ./tmp/a0000.nii $scanTSIDestinationDir/t1.nii
#----------------------------------------------------------------------------------------------------------------------------
dataDirScan=$TSISourceDir/TSI"$(printf "%02d" $i)"_0/SER2

mri_convert  --split -ot nii  $dataDirScan/IMG00001.dcm  ./tmp/b.nii >>TSImriConvertOutput.txt
...
mri_convert  --split -ot nii  $dataDirScan/IMG00001.dcm  ./tmp/c.nii >>TSImriConvertOutput.txt
...
mri_convert  --split -ot nii  $dataDirScan/IMG00001.dcm  ./tmp/a.nii >VSImriConvertOutput.txt

sudo mv ./tmp/a0000.nii $scanVSIDestinationDir/t1.nii
#----------------------------------------------------------------------------------------------------------------------------
dataDirScan=$VSISourceDir/VSI"$(printf "%02d" $i)"_0/SER2

mri_convert  --split -ot nii  $dataDirScan/IMG00001.dcm  ./tmp/b.nii >>VSImriConvertOutput.txt
...
mri_convert  --split -ot nii  $dataDirScan/IMG00001.dcm  ./tmp/c.nii >>VSImriConvertOutput.txt
